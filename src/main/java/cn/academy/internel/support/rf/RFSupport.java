...
public class RFSupport {
    ...
    private static void init(FMLInitializationEvent event) {
        ...
        GameRegistry.addShapedRecipe(new ResourceLocation("academy", "rf_input"), null, new ItemStack(rfInput), "abc", " d ", 'a', ACItems.energy_unit, 'b', ACBlocks.machine_frame, 'c', ACItems.constraint_plate, 'd', ACItems.energy_convert_component);

        GameRegistry.addShapedRecipe(new ResourceLocation("academy", "rf_output"), null, new ItemStack(rfOutput), "abc", " d ", 'a', ACItems.energy_unit, 'b', ACBlocks.machine_frame, 'c', ACItems.reso_crystal, 'd', ACItems.energy_convert_component);

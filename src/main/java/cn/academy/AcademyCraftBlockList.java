...
public class AcademyCraftBlockList {
    ...
    static {
        ...
        CAT_ENGINE.setCreativeTab(cn.academy.AcademyCraft.CREATIVE_TABS);
        ...
        CONSTRAINT_METAL.setCreativeTab(cn.academy.AcademyCraft.CREATIVE_TABS);
        ...
        CRYSTAL_ORE.setCreativeTab(cn.academy.AcademyCraft.CREATIVE_TABS);
        ...
        MACHINE_FRAME.setCreativeTab(cn.academy.AcademyCraft.CREATIVE_TABS);
        ...
        METAL_FORMER.setCreativeTab(cn.academy.AcademyCraft.CREATIVE_TABS);
        ...
        NODE_ADVANCED.setCreativeTab(cn.academy.AcademyCraft.CREATIVE_TABS);
        BLOCK_LIST.add(NODE_ADVANCED);
        NODE_BASIC.setRegistryName("academy:node_basic");
        NODE_BASIC.setTranslationKey("ac_node_basic");
        NODE_BASIC.setCreativeTab(cn.academy.AcademyCraft.CREATIVE_TABS);
        ...
        SOLAR_GEN.setCreativeTab(cn.academy.AcademyCraft.CREATIVE_TABS);

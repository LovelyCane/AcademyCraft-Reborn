...
public class VanillaHandRenderer {
    ...
    private static final Method _mGetFOVModifier = ReflectionUtils.getObfMethod(EntityRenderer.class, "getFOVModifier", "func_78481_a", java.lang.Float.TYPE, java.lang.Boolean.TYPE);
    private static final Method _mViewBobbing = ReflectionUtils.getObfMethod(EntityRenderer.class, "applyBobbing", "func_78475_f", java.lang.Float.TYPE);
    ...
    public static void renderHand(float partialTicks, CompTransform transform) {
        try {
            ...
            Project.gluPerspective((float) _mGetFOVModifier.invoke(renderer, partialTicks, false), (float) mc.displayWidth / mc.displayHeight, 0.05F, (float) _fFarPlaneDistance.get(renderer) * 2.0F);
    ...
    public enum EventHandler {
        ...
        public void onRenderHand(RenderHandEvent ev) {
            ...
            if (data.isRendererPresent()) {
                ...
                if (mc.gameSettings.thirdPersonView == 0 && !mc.player.isPlayerSleeping() && !mc.gameSettings.hideGUI) {

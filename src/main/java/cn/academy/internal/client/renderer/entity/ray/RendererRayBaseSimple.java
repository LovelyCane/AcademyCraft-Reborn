 ...
 * @author WeAthFolD
 */
public abstract class RendererRayBaseSimple extends Render<Entity> {
    ...
    @Override
    public void doRender(@Nonnull Entity ent, double x, double y, double z, float yaw, float partialTicks) {
        IRay ray = (IRay) ent;

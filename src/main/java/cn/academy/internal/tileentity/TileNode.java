...
import cn.academy.internal.block.BlockNode;
import cn.academy.internal.block.BlockNode.NodeType;
...
public class TileNode extends TileEntityInventory implements IWirelessNode, IInventory, ITickable {
    ...
    public String getNodeName() {
        return this.getPos().getX() + "-" + this.getPos().getY() + "-" + this.getPos().getZ();
    }

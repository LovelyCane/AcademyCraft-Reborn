 ...
 * @author WeAthFolD
 */
public class ItemDeveloperPortable extends ItemEnergyBase {
    ...
    public void onModelBake(ModelBakeEvent ev) {
        ...
        Matrix4f fpTrans = new TransformChain().rotate(0f, 180f, 0f).scale(.3f).translate(.34f, -.1f, -.1f).build();
        ...
        Matrix4f tpTrans = new TransformChain().rotate(0, 180, 0).scale(.2f).build();
        ...
        bakedModel.mapTransform(TransformType.GROUND, new TransformChain().scale(-.15f, -.15f, .15f).translate(0, 0.1f, 0).build());

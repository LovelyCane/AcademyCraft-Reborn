...
public class ThreateningTeleport extends Skill {
    ...
    public static class TTContext extends Context<ThreateningTeleport> {
        ...
        private float getDamage(ItemStack stack) {
            ...
            if (stack.getItem() == AcademyCraftItemList.NEEDLE)
                dmg *= 1.5f;
            return dmg;
        }
        ...
        public TraceResult calcDropPos() {
            ...
            if (pos.typeOfHit == RayTraceResult.Type.MISS) {
                ...
                ret.setPos(pos.hitVec.x, pos.hitVec.y, pos.hitVec.z);
            else {
        ...
        public void c_end(boolean attacked) {
            ...
            if (attacked) {
                ...
                while (x <= dist) {
                    ...
                    player.world.spawnEntity(TPParticleFactory.instance.next(player.world, new Vec3d(posX, posY, posZ), new Vec3d(RandUtils.ranged(-.02, .02), RandUtils.ranged(-.02, .05), RandUtils.ranged(-.02, .02))));

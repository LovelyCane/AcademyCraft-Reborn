...
import cn.academy.internal.energy.client.ui.GuiNode;
...
public class BlockNode extends ACBlockContainer {
    ...
    public enum NodeType implements IStringSerializable {
        BASIC("basic", 15000, 150, 9, 5), STANDARD("standard", 50000, 300, 12, 10), ADVANCED("advanced", 200000, 900, 19, 20);
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos) {
        ...
        return state.withProperty(CONNECTED, enabled).withProperty(ENERGY, pct);
    }
    ...
    public static GuiHandlerBase guiHandler = new GuiHandlerBase() {
        ...
        protected Object getClientContainer(EntityPlayer player, World world, int x, int y, int z) {
            ...
            return GuiNode.apply(c);
        }

        @Override
        protected Object getServerContainer(EntityPlayer player, World world, int x, int y, int z) {
            TileNode te = check(world, x, y, z);
            return new ContainerNode(te, player);
        }

...
public abstract class TileGeneratorBase extends TileInventory implements IWirelessGenerator, ITickable {
    ...
    public void update() {
        if (!getWorld().isRemote) {
            ...
            if (energy > bufferSize) energy = bufferSize;

            if (--updateTicker == 0) {
                updateTicker = 20;
                NetworkMessage.sendToAllAround(TargetPoints.convert(this, 20), this, ".tile.sync", writeToNBT(new NBTTagCompound()));
            }
        }
    }
